...
/** Funcion que crea una caja de cornell con una luz rectangular normal.
  * @param scene Vector de objetos donde se guardara la caja de cornell
  * @param cam Donde se devuelve la camara que toma la imagen
  * @param aspect Relacion de aspecto de la imagen
  */
...
/** Funcion que crea una caja de cornell con una luz rectangular grande.
  * @param scene Vector de objetos donde se guardara la caja de cornell
  * @param cam Donde se devuelve la camara que toma la imagen
  * @param aspect Relacion de aspecto de la imagen
  */
...
/** Funcion que crea una caja de cornell con objetos representando los cuatro tipos de materiales.
  * @param scene Vector de objetos donde se guardara la caja de cornell
  * @param cam Donde se devuelve la camara que toma la imagen
  * @param aspect Relacion de aspecto de la imagen
  */
...
/** Funcion que crea una caja de cornell con una luz de elipse.
  * @param scene Vector de objetos donde se guardara la caja de cornell
  * @param cam Donde se devuelve la camara que toma la imagen
  * @param aspect Relacion de aspecto de la imagen
  */
...
int main() {
  // Al main se le han anadido las luces nuevas, en la definicion de light_shape, y en lugar de llamar a la funcion cornell_box se llama a la correspondiente segun que luz queramos. La mayoria del codigo del main se ha dejado intacto.

  // Hay tambien comentarios referentes a las ordenes necesarias para crear los batches de imagenes usados para los experimentos. En lugar de imprimir por pantalla el ppm, se imprimia directamente en los ficheros necesarios.
  ...
  //for(int test_n = 1; test_n <= 20; test_n++){
    ...
    // El mundo, se utiliza la funcion dependiendo de que luz se quiera usar.
